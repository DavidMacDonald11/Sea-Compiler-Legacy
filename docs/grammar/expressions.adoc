...
`_array-list_`:
{tab} `_expression_`
{tab} `_array-list_` `*,*` `_expression_`~opt~
...
{tab} `_postfix-access-expression_`
...
`_postfix-access-expression_`:
{tab} `_postfix-expression_` `*[*` `_expression_` `_split-expression_`~opt~ `_split-expression_`~opt~ `*]*`
{tab} `_postfix-expression_` `*[*` `_split-expression_`~opt~ `_split-expression_`~opt~`*]*`
`_split-expression_`:
{tab} `*:*` `_expression_`~opt~
