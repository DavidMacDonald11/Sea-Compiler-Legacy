...
{tab} `*(*` `_expression_` `*)*`
{tab} `*|*` `_expression_` `*|*`
{tab} `_generic-selection_`

`_generic-selection_`:
{tab} `*generic*` `*(*` `_assignment-expression_` `*,*` `_generic-association-list_` `*)*`

`_generic-association-list_`:
{tab} `_generic-association_`
{tab} `_generic-association-list_` `*,*` `_generic-association_`

`_generic-association_`:
{tab} `_type-name_` `*:*` `_assignment-experssion_`
{tab} `*default*` `*:*` `_assignment-expression_`

`_postfix-expression_`:
{tab} `_primary-expression_`
{tab} `_postfix-expression_` `*{lbracket}*` `_expression_` `*]*`
...
{tab} `*(*` `_type-name_` `*{*` `_initializer-list_` `*}*` `*)*`
{tab} `*(*` `_type-name_` `*{*` `_initializer-list_` `*}*` `*,*` `*)*`
...
{tab} `*size*` `*of*` `_unary-expression_`
{tab} `*size*` `*of*` `*(*` `_type-name_` `*)*` `*align*` `*of*` `*(*` `_type-name_` `*)*`
